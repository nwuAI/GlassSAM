...
from .modeling import ImageEncoderViT, MaskDecoder, PromptEncoder, Sam, XMDAFusionBlock, GatedXMDAFusionBlock, TwoWayTransformer, Add, Fusion_Sagate, MDA, CBAM, DepthEncoder_small, DepthEncoder_resnet50, DepthEncoder_b0, DepthEncoder_b1, DepthEncoder_b2, DepthEncoder_b3, DepthEncoder_b4, DepthEncoder_b5, Depthdecoder, DepthEncoder_resnet101, MaskDecoder_irseg_new#, Fusion_weight_aspp, DepthDecoder_fusion_CA
from torch.nn import functional as F
from models.SamFeatSeg import SegDecoderCNN, SamFeatSeg
from models.autosam2.model_single import ModelEmb
...
def _build_sam(
    ...
    image_embedding_size = [size // vit_patch_size for size in image_size]    ###修改后尺寸h和w可以不统一

    sam = Sam(
        add=Add(),
        xmda=XMDAFusionBlock(c_rgb=256, c_x=256),
        depth_encoder=DepthEncoder_b3(),
        # depth_encoder=DepthEncoder_small(),
        # depth_encoder=DepthEncoder_b0(),
        # depth_encoder=DepthEncoder_resnet50(),
        ...
        # prompt_encoder=ModelEmb(args=args1),
        ...
        # mask_decoder=SegDecoderCNN(num_classes=1, embed_dim=256),
...
def load_from(sam, state_dicts, image_size, vit_patch_size):
    ...
    token_size = [int(img_size // vit_patch_size) for img_size in image_size]
